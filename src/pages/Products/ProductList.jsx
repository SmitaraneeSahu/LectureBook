...
export default function ProductList() {
    useTitle("Explore Course Collection");
    const { productList, initialProductList } = useFilter();
    const [show, setShow] = useState(false);
    // const [products, setProducts] = useState([]);
    const search = useLocation().search;
    const searchTerm = new URLSearchParams(search).get("name_like");
    ...
    <main className='bg-white dark:bg-gray-900'>
        <section className='my-5'>
            <div className='my-5 flex justify-between'>
                <span className='text-2xl font-semibold dark:text-slate-100 mb-5'>All Courses ({productList.length})</span>
                <span>
            ...
            <div className='flex flex-wrap justify-content lg:flex-row'>
